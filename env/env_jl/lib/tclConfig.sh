...
# installed.
TCL_PREFIX='/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/tk_1645033378611/work=/usr/local/src/conda/tk-8.6.12 -fdebug-prefix-map=/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/lib -Wl,-rpath-link,/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/lib -L/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/lib -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/include'
...
# compiled.
TCL_SRC_DIR='/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/include'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/lib -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/lib/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/labri_joaomotta/codigo/fundamentos-de-ciencias-de-dados/env/env_jl/lib/libtclstub8.6.a'
